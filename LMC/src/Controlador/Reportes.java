...
public class Reportes {
    ...
    public void generar(String nombreReporte){
        ...
        try(Connection conexion= DriverManager.getConnection(urlBD, usuarioBD, passwordBD)){
            ...
            if(e.getMessage().contains("Error executing SQL statement"))
                bdVacia= true;
        }
    }
